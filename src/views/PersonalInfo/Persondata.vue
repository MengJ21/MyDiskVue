    ...
    export default {
        ...
        methods: {
            save() {
                ...
                // console.log('user_')
                // console.log(user_)
                let url = 'http://localhost:8081/runyun/updateUserInfo/'+this.$global_msg.userId;
            ...
            savePd() {
                ...
                let reptPd = this.password2;
                if (pd != reptPd) {
                    alert("密码不一致！");
                } else {
                    let d = {};
                    d.password = pd;
                    let url = 'http://localhost:8081/runyun/updatePd/'+this.$global_msg.userId;
